...
import { registerWorkerAction } from '../../../config/redux/action/registerWorkerAction'
...
const RegisterWorker = () => {
  ...
  const {loading} = useSelector((state)=>state.registerWorker)
  ...
  const handleSubmit = () => {
    dispatch(registerWorkerAction(form, navigate))
  }
  return (
    <div className='w-[570px] h-auto flex flex-col justify-center max-laptop:w-[90%] max-laptop:max-w-[768px]'>
      ...
      <div className='flex flex-col gap-8 mb-16'>
        ...
        <Input type='text' name='phone' placeholder='Input phone number' label='Phone Number' value={form.phone} onChange={handleChange} />
