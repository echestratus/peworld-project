...
const Searchbar = () => {
  return (
    <div className='w-full h-auto bg-white flex items-center rounded-lg'>
        <input type="text" placeholder='Search for any skill' className='object-cover rounded-lg border-none outline-none w-[840px] h-[70px] pl-5 text-[14px] placeholder:text-[#9EA0A5] placeholder:text-[14px]'  />
